...
B = torch.load("/dev/shm/geo1b/fl_streamC8192/banks_flagship.pt",
               map_location="cpu", weights_only=False)
MODS, C, K = B["modules"], int(B["C"]), 5
...
KEEP = [0, 16, 64, 128, 192, 256, 384, 512, 768, 1024, 1536, 2048, 3072, 4096, 6144, C]
...
open("out/suff1b_flagship.json", "w").write(json.dumps(out, indent=1))
